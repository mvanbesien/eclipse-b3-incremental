...
public enum Messages {
	PATH_NOT_FOUND("PATH_NOT_FOUND"), FILE_NOT_FOUND("FILE_NOT_FOUND"), FILE_NOT_READABLE("FILE_NOT_READABLE"), CHECKING_LAST_UPDATE("CHECKING_LAST_UPDATE"), REPO_NOT_FOUND_IN_FILE("REPO_NOT_FOUND_IN_FILE"), REPO_NOT_DATED("REPO_NOT_DATED"), AGGREGATION_WILL_HAPPEN("AGGREGATION_WILL_HAPPEN"), AN_ERROR_OCCURRED("AN_ERROR_OCCURRED"), AGGREGATION_SKIPPED("AGGREGATION_SKIPPED"), ON_EXCEPTION("ON_EXCEPTION"), REPO_CHECK_RESULT("REPO_CHECK_RESULT")
	;
